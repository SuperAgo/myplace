var	playlist = [
	{title:"Spoons for Loons",artist:"Deep East Music",mp3:"../mp3/Deep East Music - Spoons for Loons.mp3",cover:"../images/album_cover/Spoons for Loons.jpg"},
	{title:"a cute date",artist:"elijah who",mp3:"../mp3/elijah who - a cute date.mp3",cover:"../images/album_cover/a cute date.jpg"},
	{title:" Seba ft.Jbird",artist:"Lord Roc",mp3:"../mp3/Lord Roc - Seba ft.Jbird.mp3",cover:"../images/album_cover/Seba ft.Jbird.jpg"},
	{title:"dancing",artist:"mellow fellow",mp3:"../mp3/mellow fellow - dancing.mp3",cover:"../images/album_cover/dancing.jpg"},
	{title:"Princess",artist:"α·Pav",mp3:"../mp3/α·Pav - Princess.mp3",cover:"../images/album_cover/Princess.jpg"},
	{title:"时代を超える想い2",artist:"和田薫",mp3:"../mp3/和田薫 - 时代を超える想い2.mp3",cover:"../images/album_cover/时代を超える想い2.jpg"},
	{title:"Blame You",artist:"眠,Lopu$",mp3:"../mp3/眠,Lopu$ - Blame You.mp3",cover:"../images/album_cover/Blame You.jpg"}
];
var isRotate = true;
var autoplay = false;
...
(function($){
	...
	$('.playback').on('click', function(){
		if ($(this).hasClass('playing')){
			$('.mobile-nav-menu .music-toggle-close').find("i").removeClass('fa fa-pause-circle').addClass('fa fa-play-circle');
			clearInterval(InterVal);
			pause();
		} else {
			$('.mobile-nav-menu .music-toggle-close').find("i").removeClass('fa fa-play-circle').addClass('fa fa-pause-circle');
			rotate();
			play();
		}
	});
	...
	$("#QPlayer .ssBtn").on('click', function(){
		...
		if ($('.ssBtn .adf').hasClass('on') === false) {
			...
			$('.mobile-nav-menu .music-toggle').click();
		} else {	
			mA.css("transform", "translateX(0px)");
            $('.ssBtn .adf').removeClass('on');
			$('.mobile-nav-menu .music-toggle-close').click();
		}
	}); 
