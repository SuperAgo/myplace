var CanvasParticle = (function(){
	...
	function canvasInit(canvasConfig){
		...
		var canvas = {
			...
			config: {
				...
				color: canvasConfig.color || "255,182,193",
				stroke: canvasConfig.stroke || "220,220,220",
	...
	function canvasSize(canvas){
		...
		// 获取特定div的宽高
		var width = document.getElementsByTagName("body")[0].style.width;
		var height = document.getElementsByTagName("body")[0].style.height;
